...
class StableGPTModel(MegatronBaseModel, TextGeneration):
    """
    Stable GPT pretraining
    """
    ...
    def model_provider_func(self, pre_process, post_process):
        ...
        model = GPTModel(
            ...
            precision=self.cfg.get('precision', 'bf16'),
    ...
    def training_step(self, dataloader_iter, batch_idx):
        ...
        self.cfg.precision = "bf16"
        if self.cfg.precision == 16:
            loss_scale = self.trainer.precision_plugin.scaler._scale
            if loss_scale is not None:
                self.log('loss_scale', loss_scale, batch_size=1)

        self.log('TFLOPS_per_gpu', tflops_per_s_per_gpu, prog_bar=True, rank_zero_only=True, batch_size=1)
